...
--dome2 = WidgetLib2.newSimple("dome")
--dome = dome or {}

do
 dome.model = {}
 do dome.makeModel = function(r,step,model)
  --local model = {}
  local pts1 = {}
  local pts2 = {}
 ...
 domeco = coroutine.create(dome.makeModel)

 --dome.model = dome.makeModel(12,5)
 coroutine.resume(domeco,12,5,dome.model)
end
