...
-- add concepts for the phrases and concepts for the chords
-- In all the excitement I lost track of that fact that these
-- are actually separate things

-- There are 4 "things" at the moment that this concept network
-- "thinks" about at any given time.
...
function codelets.makeGreen()
  ...
  --print("V")
  -- move this key change logic to where the chord change happens, where it can then
  -- check for a dominant, and apply this logic if that is so.
  ...
  -- turn this off for now, just want to use fugue.phrases[1]
  -- fugue.currentPhrase = fugue.phrases[2]
end
...
function codelets.makeBlue()
  ...
  --print("IV")
  -- turn this off for now, just want to use fugue.phrases[1]
  -- fugue.currentPhrase = fugue.phrases[3]
end
...
function codelets.makePurple()
  ...
  --print("II")
  -- turn this off for now, just want to use fugue.phrases[1]
  -- fugue.currentPhrase = fugue.phrases[4]
end
