...
for i=1,12,1 do
  ...
  setKeyHandlerProgram(keymap,  stdkeyids.fnkey(i), 1, "f"..i.."ShiftPressed()")
  setKeyHandlerProgram(keymap2, stdkeyids.fnkey(i), 1, "f"..i.."ShiftPressed()")
  
  setKeyHandlerProgram(keymap,  stdkeyids.fnkey(i), 2, "f"..i.."CtrlPressed()")
  setKeyHandlerProgram(keymap2, stdkeyids.fnkey(i), 2, "f"..i.."CtrlPressed()")
  
  setKeyHandlerProgram(keymap,  stdkeyids.fnkey(i), 3, "f"..i.."CtrlShiftPressed()")
  setKeyHandlerProgram(keymap2, stdkeyids.fnkey(i), 3, "f"..i.."CtrlShiftPressed()")
end
