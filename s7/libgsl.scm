...
;; 1.16?		    (double gsl_bspline_greville_abscissa (size_t gsl_bspline_workspace*))
		    (int gsl_bspline_knots (gsl_vector* gsl_bspline_workspace*))
		    (int gsl_bspline_knots_uniform (double double gsl_bspline_workspace*))
;; 1.16?		    (int gsl_bspline_knots_greville (gsl_vector* gsl_bspline_workspace* double*))
...
;; 1.16?		    (void gsl_sort_vector2 (gsl_vector* gsl_vector*))
...
;; 1.16?		    (int gsl_poly_dd_hermite_init (double* double* double* double* double* size_t))
...
;;		    (int gsl_blas_sdot (gsl_vector_float* gsl_vector_float* float*))
		    (int gsl_blas_ddot (gsl_vector* gsl_vector* double*))
		    (int gsl_blas_cdotu (gsl_vector_complex_float* gsl_vector_complex_float* gsl_complex_float*))
		    (int gsl_blas_cdotc (gsl_vector_complex_float* gsl_vector_complex_float* gsl_complex_float*))
		    ...
		    (float gsl_blas_snrm2 (gsl_vector_float*))
		    (float gsl_blas_sasum (gsl_vector_float*))
		    (double gsl_blas_dnrm2 (gsl_vector*))
		    (double gsl_blas_dasum (gsl_vector*))
		    (float gsl_blas_scnrm2 (gsl_vector_complex_float*))
		    (float gsl_blas_scasum (gsl_vector_complex_float*))
		    (double gsl_blas_dznrm2 (gsl_vector_complex*))
		    (double gsl_blas_dzasum (gsl_vector_complex*))
		    (size_t_t gsl_blas_isamax (gsl_vector_float*))
		    (size_t_t gsl_blas_idamax (gsl_vector*))
		    (size_t_t gsl_blas_icamax (gsl_vector_complex_float*))
		    (size_t_t gsl_blas_izamax (gsl_vector_complex*))
		    (int gsl_blas_sswap (gsl_vector_float* gsl_vector_float*))
		    (int gsl_blas_scopy (gsl_vector_float* gsl_vector_float*))
		    (int gsl_blas_saxpy (float gsl_vector_float* gsl_vector_float*))
		    ...
		    (int gsl_blas_cswap (gsl_vector_complex_float* gsl_vector_complex_float*))
		    (int gsl_blas_ccopy (gsl_vector_complex_float* gsl_vector_complex_float*))
		    (int gsl_blas_zswap (gsl_vector_complex* gsl_vector_complex*))
		    (int gsl_blas_zcopy (gsl_vector_complex* gsl_vector_complex*))
;;		    (int gsl_blas_srotg (float float float float*))
;;		    (int gsl_blas_srotmg (float float float float float*))
		    (int gsl_blas_srot (gsl_vector_float* gsl_vector_float* float float))
;;		    (int gsl_blas_srotm (gsl_vector_float* gsl_vector_float* float*))
		    ...
		    (void gsl_blas_sscal (float gsl_vector_float*))
		    (void gsl_blas_dscal (double gsl_vector*))
		    (void gsl_blas_csscal (float gsl_vector_complex_float*))
		    (void gsl_blas_zdscal (double gsl_vector_complex*))
		    (int gsl_blas_sgemv (int float gsl_matrix_float* gsl_vector_float* float gsl_vector_float*))
		    (int gsl_blas_strmv (int int int gsl_matrix_float* gsl_vector_float*))
		    (int gsl_blas_strsv (int int int gsl_matrix_float* gsl_vector_float*))
		    ...
		    (int gsl_blas_ctrmv (int int int gsl_matrix_complex_float* gsl_vector_complex_float*))
		    (int gsl_blas_ctrsv (int int int gsl_matrix_complex_float* gsl_vector_complex_float*))
		    ...
		    (int gsl_blas_ssymv (int float gsl_matrix_float* gsl_vector_float* float gsl_vector_float*))
		    (int gsl_blas_sger (float gsl_vector_float* gsl_vector_float* gsl_matrix_float*))
		    (int gsl_blas_ssyr (int float gsl_vector_float* gsl_matrix_float*))
		    (int gsl_blas_ssyr2 (int float gsl_vector_float* gsl_vector_float* gsl_matrix_float*))
		    ...
		    (int gsl_blas_cher (int float gsl_vector_complex_float* gsl_matrix_complex_float*))
;; complex		    (int gsl_blas_zaxpy (gsl_complex gsl_vector_complex* gsl_vector_complex*))
;; complex		    (void gsl_blas_zscal (gsl_complex gsl_vector_complex*))
;; complex		    (int gsl_blas_zgemv (int gsl_complex gsl_matrix_complex* gsl_vector_complex* gsl_complex gsl_vector_complex*))
;; complex		    (int gsl_blas_zhemv (int gsl_complex gsl_matrix_complex* gsl_vector_complex* gsl_complex gsl_vector_complex*))
;; complex		    (int gsl_blas_zgeru (gsl_complex gsl_vector_complex* gsl_vector_complex* gsl_matrix_complex*))
;; complex		    (int gsl_blas_zgerc (gsl_complex gsl_vector_complex* gsl_vector_complex* gsl_matrix_complex*))
;; complex		    (int gsl_blas_zher2 (int gsl_complex gsl_vector_complex* gsl_vector_complex* gsl_matrix_complex*))
;; complex		    (int gsl_blas_zgemm (int int gsl_complex gsl_matrix_complex* gsl_matrix_complex* gsl_complex gsl_matrix_complex*))
;; complex		    (int gsl_blas_zsymm (int int gsl_complex gsl_matrix_complex* gsl_matrix_complex* gsl_complex gsl_matrix_complex*))
;; complex		    (int gsl_blas_zsyr2k (int int gsl_complex gsl_matrix_complex* gsl_matrix_complex* gsl_complex gsl_matrix_complex*))
;; complex		    (int gsl_blas_zhemm (int int gsl_complex gsl_matrix_complex* gsl_matrix_complex* gsl_complex gsl_matrix_complex*))
;; complex		    (int gsl_blas_zsyrk (int int gsl_complex gsl_matrix_complex* gsl_complex gsl_matrix_complex*))
;; complex		    (int gsl_blas_ztrmm (int int int int gsl_complex gsl_matrix_complex* gsl_matrix_complex*))
;; complex		    (int gsl_blas_ztrsm (int int int int gsl_complex gsl_matrix_complex* gsl_matrix_complex*))
;; complex		    (int gsl_blas_zher2k (int int gsl_complex gsl_matrix_complex* gsl_matrix_complex* double gsl_matrix_complex*))
		    (int gsl_blas_zher (int double gsl_vector_complex* gsl_matrix_complex*))
		    (int gsl_blas_sgemm (int int float gsl_matrix_float* gsl_matrix_float* float gsl_matrix_float*))
		    (int gsl_blas_ssymm (int int float gsl_matrix_float* gsl_matrix_float* float gsl_matrix_float*))
		    (int gsl_blas_ssyrk (int int float gsl_matrix_float* float gsl_matrix_float*))
		    (int gsl_blas_ssyr2k (int int float gsl_matrix_float* gsl_matrix_float* float gsl_matrix_float*))
		    (int gsl_blas_strmm (int int int int float gsl_matrix_float* gsl_matrix_float*))
		    (int gsl_blas_strsm (int int int int float gsl_matrix_float* gsl_matrix_float*))
...
;; cfloat		    (int gsl_blas_caxpy (gsl_complex_float gsl_vector_complex_float* gsl_vector_complex_float*))
;; cfloat		    (void gsl_blas_cscal (gsl_complex_float gsl_vector_complex_float*))
;; cfloat		    (int gsl_blas_cgemv (int gsl_complex_float gsl_matrix_complex_float* gsl_vector_complex_float* gsl_complex_float gsl_vector_complex_float*))
;; cfloat		    (int gsl_blas_chemv (int gsl_complex_float gsl_matrix_complex_float* gsl_vector_complex_float* gsl_complex_float gsl_vector_complex_float*))
;; cfloat		    (int gsl_blas_cgeru (gsl_complex_float gsl_vector_complex_float* gsl_vector_complex_float* gsl_matrix_complex_float*))
;; cfloat		    (int gsl_blas_cgerc (gsl_complex_float gsl_vector_complex_float* gsl_vector_complex_float* gsl_matrix_complex_float*))
;; cfloat		    (int gsl_blas_cher2 (int gsl_complex_float gsl_vector_complex_float* gsl_vector_complex_float* gsl_matrix_complex_float*))
;; cfloat		    (int gsl_blas_cgemm (int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float* gsl_complex_float gsl_matrix_complex_float*))
;; cfloat		    (int gsl_blas_csymm (int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float* gsl_complex_float gsl_matrix_complex_float*))
;; cfloat		    (int gsl_blas_csyrk (int int gsl_complex_float gsl_matrix_complex_float* gsl_complex_float gsl_matrix_complex_float*))
;; cfloat		    (int gsl_blas_csyr2k (int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float* gsl_complex_float gsl_matrix_complex_float*))
;; cfloat		    (int gsl_blas_ctrmm (int int int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float*))
;; cfloat		    (int gsl_blas_ctrsm (int int int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float*))
;; cfloat		    (int gsl_blas_chemm (int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float* gsl_complex_float gsl_matrix_complex_float*))
;; cfloat		    (int gsl_blas_cher2k (int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float* float gsl_matrix_complex_float*))
		    (int gsl_blas_cherk (int int float gsl_matrix_complex_float* float gsl_matrix_complex_float*))
		    (int gsl_blas_zherk (int int double gsl_matrix_complex* double gsl_matrix_complex*))
;;		    (float cblas_sdsdot (int float float* int float* int))
;;		    (double cblas_dsdot (int float* int float* int))
;;		    (float cblas_sdot (int float* int float* int))
		    (double cblas_ddot (int double* int double* int))
		    (void cblas_cdotu_sub (int void* int void* int void*))
		    (void cblas_cdotc_sub (int void* int void* int void*))
		    (void cblas_zdotu_sub (int void* int void* int void*))
		    (void cblas_zdotc_sub (int void* int void* int void*))
;;		    (float cblas_snrm2 (int float* int))
;;		    (float cblas_sasum (int float* int))
		    (double cblas_dnrm2 (int double* int))
		    (double cblas_dasum (int double* int))
		    (float cblas_scnrm2 (int void* int))
		    (float cblas_scasum (int void* int))
		    (double cblas_dznrm2 (int void* int))
		    (double cblas_dzasum (int void* int))
;;		    (size_t cblas_isamax (int float* int))
...
;;		    (void cblas_scopy (int float* int float* int))
;;		    (void cblas_saxpy (int float float* int float* int))
		    ...
		    (void cblas_cswap (int void* int void* int))
		    (void cblas_ccopy (int void* int void* int))
		    (void cblas_caxpy (int void* void* int void* int))
		    (void cblas_zswap (int void* int void* int))
		    (void cblas_zcopy (int void* int void* int))
		    (void cblas_zaxpy (int void* void* int void* int))
...
;;		    (void cblas_srotm (int float* int float* int float*))
...
;;		    (void cblas_sscal (int float float* int))
		    ...
		    (void cblas_cscal (int void* void* int))
		    (void cblas_zscal (int void* void* int))
		    (void cblas_csscal (int float void* int))
		    (void cblas_zdscal (int double void* int))
;;		    (void cblas_sgemv (int int int int float float* int float* int float float* int))
;;		    (void cblas_sgbmv (int int int int int int float float* int float* int float float* int))
;;		    (void cblas_strmv (int int int int int float* int float* int))
;;		    (void cblas_stbmv (int int int int int int float* int float* int))
;;		    (void cblas_stpmv (int int int int int float* float* int))
;;		    (void cblas_strsv (int int int int int float* int float* int))
;;		    (void cblas_stbsv (int int int int int int float* int float* int))
;;		    (void cblas_stpsv (int int int int int float* float* int))
		    ...
		    (void cblas_cgemv (int int int int void* void* int void* int void* void* int))
		    (void cblas_cgbmv (int int int int int int void* void* int void* int void* void* int))
		    (void cblas_ctrmv (int int int int int void* int void* int))
		    (void cblas_ctbmv (int int int int int int void* int void* int))
		    (void cblas_ctpmv (int int int int int void* void* int))
		    (void cblas_ctrsv (int int int int int void* int void* int))
		    (void cblas_ctbsv (int int int int int int void* int void* int))
		    (void cblas_ctpsv (int int int int int void* void* int))
		    (void cblas_zgemv (int int int int void* void* int void* int void* void* int))
		    (void cblas_zgbmv (int int int int int int void* void* int void* int void* void* int))
		    (void cblas_ztrmv (int int int int int void* int void* int))
		    (void cblas_ztbmv (int int int int int int void* int void* int))
		    (void cblas_ztpmv (int int int int int void* void* int))
		    (void cblas_ztrsv (int int int int int void* int void* int))
		    (void cblas_ztbsv (int int int int int int void* int void* int))
		    (void cblas_ztpsv (int int int int int void* void* int))
;;		    (void cblas_ssymv (int int int float float* int float* int float float* int))
;;		    (void cblas_ssbmv (int int int int float float* int float* int float float* int))
;;		    (void cblas_sspmv (int int int float float* float* int float float* int))
;;		    (void cblas_sger (int int int float float* int float* int float* int))
;;		    (void cblas_ssyr (int int int float float* int float* int))
;;		    (void cblas_sspr (int int int float float* int float*))
;;		    (void cblas_ssyr2 (int int int float float* int float* int float* int))
;;		    (void cblas_sspr2 (int int int float float* int float* int float*))
		    ...
		    (void cblas_chemv (int int int void* void* int void* int void* void* int))
		    (void cblas_chbmv (int int int int void* void* int void* int void* void* int))
		    (void cblas_chpmv (int int int void* void* void* int void* void* int))
		    (void cblas_cgeru (int int int void* void* int void* int void* int))
		    (void cblas_cgerc (int int int void* void* int void* int void* int))
		    (void cblas_cher (int int int float void* int void* int))
		    (void cblas_chpr (int int int float void* int void*))
		    (void cblas_cher2 (int int int void* void* int void* int void* int))
		    (void cblas_chpr2 (int int int void* void* int void* int void*))
		    (void cblas_zhemv (int int int void* void* int void* int void* void* int))
		    (void cblas_zhbmv (int int int int void* void* int void* int void* void* int))
		    (void cblas_zhpmv (int int int void* void* void* int void* void* int))
		    (void cblas_zgeru (int int int void* void* int void* int void* int))
		    (void cblas_zgerc (int int int void* void* int void* int void* int))
		    (void cblas_zher (int int int double void* int void* int))
		    (void cblas_zhpr (int int int double void* int void*))
		    (void cblas_zher2 (int int int void* void* int void* int void* int))
		    (void cblas_zhpr2 (int int int void* void* int void* int void*))
;;		    (void cblas_sgemm (int int int int int int float float* int float* int float float* int))
;;		    (void cblas_ssymm (int int int int int float float* int float* int float float* int))
;;		    (void cblas_ssyrk (int int int int int float float* int float float* int))
;;		    (void cblas_ssyr2k (int int int int int float float* int float* int float float* int))
;;		    (void cblas_strmm (int int int int int int int float float* int float* int))
;;		    (void cblas_strsm (int int int int int int int float float* int float* int))
		    ...
		    (void cblas_cgemm (int int int int int int void* void* int void* int void* void* int))
		    (void cblas_csymm (int int int int int void* void* int void* int void* void* int))
		    (void cblas_csyrk (int int int int int void* void* int void* void* int))
		    (void cblas_csyr2k (int int int int int void* void* int void* int void* void* int))
		    (void cblas_ctrmm (int int int int int int int void* void* int void* int))
		    (void cblas_ctrsm (int int int int int int int void* void* int void* int))
		    (void cblas_zgemm (int int int int int int void* void* int void* int void* void* int))
		    (void cblas_zsymm (int int int int int void* void* int void* int void* void* int))
		    (void cblas_zsyrk (int int int int int void* void* int void* void* int))
		    (void cblas_zsyr2k (int int int int int void* void* int void* int void* void* int))
		    (void cblas_ztrmm (int int int int int int int void* void* int void* int))
		    (void cblas_ztrsm (int int int int int int int void* void* int void* int))
		    (void cblas_chemm (int int int int int void* void* int void* int void* void* int))
		    (void cblas_cherk (int int int int int float void* int float void* int))
		    (void cblas_cher2k (int int int int int void* void* int void* int float void* int))
		    (void cblas_zhemm (int int int int int void* void* int void* int void* void* int))
		    (void cblas_zherk (int int int int int double void* int double void* int))
		    (void cblas_zher2k (int int int int int void* void* int void* int double void* int))
...
;; fn_t		    (int gsl_heapsort_index (size_t* void* size_t size_t int))
		    ...
		    (int gsl_ieee_read_mode_string (char* int* int* int*) )
		    ...
		    (int gsl_integration_qag (gsl_function* double double double double size_t int gsl_integration_workspace* double* double*))
		    (int gsl_integration_qagi (gsl_function* double double size_t gsl_integration_workspace* double* double*))
		    (int gsl_integration_qagiu (gsl_function* double double double size_t gsl_integration_workspace* double* double*))
		    (int gsl_integration_qagil (gsl_function* double double double size_t gsl_integration_workspace* double* double*))
		    (int gsl_integration_qags (gsl_function* double double double double size_t gsl_integration_workspace* double* double*))
		    (int gsl_integration_qagp (gsl_function* double* size_t double double size_t gsl_integration_workspace* double* double*))
		    (int gsl_integration_qawc (gsl_function* double double double double double size_t gsl_integration_workspace* double* double*))
...
;; 1.16?		    (int gsl_linalg_SV_leverage (gsl_matrix* gsl_vector*))
...
;; 1.16?		    (gsl_multifit_robust_workspace* gsl_multifit_robust_alloc (gsl_multifit_robust_type* size_t size_t))
;; 1.16?		    (void gsl_multifit_robust_free (gsl_multifit_robust_workspace*))
;; 1.16?		    (int gsl_multifit_robust_tune (double gsl_multifit_robust_workspace*))
;; 1.16?		    (char* gsl_multifit_robust_name (gsl_multifit_robust_workspace*))
;; 1.16?		    (gsl_multifit_robust_stats gsl_multifit_robust_statistics (gsl_multifit_robust_workspace*))
;; 1.16?		    (int gsl_multifit_robust (gsl_matrix* gsl_vector* gsl_vector* gsl_matrix* gsl_multifit_robust_workspace*))
;; 1.16?		    (int gsl_multifit_robust_est (gsl_vector* gsl_vector* gsl_matrix* double* double*))
...
;; 1.16?		    (int gsl_multifit_fsolver_driver (gsl_multifit_fsolver* size_t double double))
...
;; 1.16?		    (int gsl_multifit_fdfsolver_driver (gsl_multifit_fdfsolver* size_t double double))
...
;; 1.16?		    (int gsl_multifit_fdfsolver_dif_df (gsl_vector* gsl_multifit_function_fdf* gsl_vector* gsl_matrix*))
;; 1.16?		    (int gsl_multifit_fdfsolver_dif_fdf (gsl_vector* gsl_multifit_function_fdf* gsl_vector* gsl_matrix*))
		    (int gsl_multimin_diff (gsl_multimin_function* gsl_vector* gsl_vector*))
		    (gsl_multimin_fminimizer* gsl_multimin_fminimizer_alloc (gsl_multimin_fminimizer_type* size_t))
		    (int gsl_multimin_fminimizer_set (gsl_multimin_fminimizer* gsl_multimin_function* gsl_vector* gsl_vector*))
		    ...
		    (int gsl_multiroot_fsolver_set (gsl_multiroot_fsolver* gsl_multiroot_function* gsl_vector*))
		    ...
		    (gsl_ntuple* gsl_ntuple_open (char* void* size_t))
		    (gsl_ntuple* gsl_ntuple_create (char* void* size_t))
		    (int gsl_ntuple_write (gsl_ntuple*))
		    (int gsl_ntuple_read (gsl_ntuple*))
		    (int gsl_ntuple_bookdata (gsl_ntuple*))
